...
/**
 * Template Name: Customer Email Notifications
 *
			...
			<div class="col-md-4 col-lg-3 theiaStickySidebar dashboard-nav">
				...
				<div class="widget settings-menu sidebar-menu" id="sidebar-menu">
                    ...
                    <?php if (in_array($role, array( 'owner'))) : ?>
							<li  class="active" ><a href="<?php echo esc_url( home_url( '/' ) ); ?>customer-email-notification"><i class="feather-gift"></i> <?php esc_html_e('Email Notification', 'truelysell'); ?> </a></li>
						<?php endif; ?>
                    <!------------END-------------->
