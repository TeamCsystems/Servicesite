...
/**
 * Template Name: Staff Bookings History
 *
...
?>		<div class="row">
			<div class="col-md-4 col-lg-3 theiaStickySidebar dashboard-nav">
				...
				<div class="widget settings-menu sidebar-menu" id="sidebar-menu">
					...
					<?php endif; ?>
						<li class="active"><a href=""><i class="feather-user"></i> <?php esc_html_e('Booking History', 'truelysell'); ?></a></li>
		...
		<div class="col-md-8 col-lg-9 dashboard-nav">
				<div id="main">
    					...
    					<h3>Completed Booking List</h3>
    	<?php
    	global $wpdb;
	$table_b = $wpdb->prefix . 'bookings_calendar';

	$query = $wpdb->prepare("SELECT * FROM $table_b WHERE owner_id = %d AND booking_status = 'completed'", $current_business_id);
