...
$(document).ready(function(){
   ...
   $('.stars a').on( "click", function() {
			...
			if($(window).scrollTop() > headerOffset){
				...
				$("#navigation.style-2.cloned").addClass('unsticky').removeClass("sticky");
                    ...
                    $(document.body).on("added_to_cart", function () {
                     $('body').addClass('truelysell_adding_to_cart');
					 	setTimeout(function () {
              				$("body").removeClass("truelysell_adding_to_cart");
            			}, 2000);
                    });
	...
	//if ($('.select2-single').data('select2')) {
		//$('.select2-single').select2('destroy');
	  //}
	  
	  if ($('.select2-single').hasClass("select2-hidden-accessible")) {
...
$('.simple-fw-slick-carousel').each(function() {
    ...
    /*----------------------------------------------------*/
    $(window).on('load', function() {
		$(".truelysell-dashoard-widgets .dashboard-stat-content h4").counterUp({
      delay: 100,
      time: 800,
...
/*--------------------------------------------------*/
	...
	$(".truelysell-flatpickr").flatpickr({
		enableTime: true,
		noCalendar: true,
		dateFormat: "H:i",
		time_24hr: time24,
