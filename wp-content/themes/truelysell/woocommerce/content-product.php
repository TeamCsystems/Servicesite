	...
	<li <?php post_class( $classes ); ?>>
		...
		<?php if( $product->is_featured() ) : ?>
			<div class="listing-badge">
				<span class="featured"><?php esc_html_e('Featured','truelysell'); ?></span>
			</div>
		<?php endif; ?>
		...
		<div class="plan-features">
                <ul class="plan-features-auto-wc">
                    ...
                    if(!$propertieslimit){
                        echo "<li>";
                         esc_html_e('Unlimited number of listings','truelysell'); 
                         echo "</li>";
                    } else { ?>
                        <li>
                            <?php esc_html_e('This plan includes ','truelysell'); printf( _n( '%d listing', '%s listings', $propertieslimit, 'truelysell' ) . ' ', $propertieslimit ); ?>
                        </li>
                    <?php } ?>
                    <?php if( $product->get_duration() ) { ?>
                    <li>
                        <?php esc_html_e('Listings are visible ','truelysell'); printf( _n( 'for %s day', 'for %s days', $product->get_duration(), 'truelysell' ), $product->get_duration() ); ?>
                    </li>
                	<?php } ?>
...
<?php 
	...
	?>
			...
			<section class="product-titleinfo">
