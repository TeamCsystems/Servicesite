...
$parallax 			= get_post_meta($post->ID, 'truelysell_parallax_image', TRUE);
$parallax_color 	= get_post_meta($post->ID, 'truelysell_parallax_color', TRUE);
$parallax_opacity 	= get_post_meta($post->ID, 'truelysell_parallax_opacity', TRUE);
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    if(isset($_GET['keyword_search'])) {
                        ...
                        printf(
                            _n(  'We\'ve found <em class="count_properties">%s</em> <em class="count_text">listing</em> for you', 'We\'ve found <em class="count_properties">%s</em> <em class="count_text">listings</em> for you' , $count, 'truelysell' ), 
                            $count); 
                        ?>
                        </span>
                        <?php
