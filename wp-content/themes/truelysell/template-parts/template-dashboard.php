...
<div style="text-align: center;">
    <a href="<?php the_author_meta( '_whatsapp', $current_user->ID ); ?>" target><img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2024/03/whatsapp.png" style="width: 30px !important; height: 30px !important; border: none; display: inline-block;vertical-align: text-bottom;"></a>
    &nbsp;
    <a href="<?php the_author_meta( '_instagram_link', $current_user->ID ); ?>"><i class="feather-instagram" style="font-size: 25px; display: inline-block;"></i></a>
    &nbsp;
    <a href="tel:<?php the_author_meta( 'phone', $current_user->ID ); ?>"><i class="feather-phone-call" style="font-size: 25px; display: inline-block;"></i></a>
    &nbsp;
    <a href="<?php the_author_meta( '_waze', $current_user->ID ); ?>"><img src="<?php echo esc_url( home_url( '/' ) ); ?>wp-content/uploads/2024/03/gps.png" style="width: 30px !important; height: 30px !important; border: none; display: inline-block;vertical-align: text-bottom;"></a>
</div>
<?php endif; ?>
				...
				<div class="widget settings-menu sidebar-menu" id="sidebar-menu">
					...
					<?php if (in_array($role, array('administrator', 'admin', 'owner', 'seller'))) : ?>
						...
						if ($dashboard_page) : ?>
							<li <?php if ($post->ID == $dashboard_page) : ?>class="active" <?php endif; ?>><a   href="<?php echo esc_url(get_permalink($dashboard_page)); ?>"><i class="feather-grid"></i><?php esc_html_e('Dashboard', 'truelysell'); ?></a></li>
						<?php endif; ?>
					<?php endif; ?>
					<!-- Staff  -->
						...
						<?php if (in_array($role, array('administrator', 'admin', 'owner', 'seller'))) : ?>
							...
							<li class="" ><a><i class="feather-user"></i> <?php esc_html_e('My Staffs', 'truelysell'); ?> <span class="menu-arrow"></span></a>

								<ul>
									<li class="">
									    <a href="<?php echo esc_url( home_url( '/' ) ); ?>/add-staff"><?php esc_html_e('Add Staff', 'truelysell'); ?>
										</a>
									</li>
									<li>
										<a href="<?php echo esc_url( home_url( '/' ) ); ?>/all-staffs"><?php esc_html_e('All Staffs', 'truelysell'); ?>
										</a>
									</li>
									<!--<li>-->
					...
					if (truelysell_fl_framework_getoptions('owners_can_book')) {
						...
						if (!in_array($role, array('owner', 'seller', 'staff'))) : ?>
