...
<div class="container">
			 <div class="row">
				<div class="col-md-6 text-start">
                    <a href="mailto:<?php echo truelysell_fl_framework_getoptions('header_email'); ?>"><i class="fas fa-envelope-o me-2"></i><?php echo truelysell_fl_framework_getoptions('header_email'); ?></a>
					<a href="tel:<?php echo truelysell_fl_framework_getoptions('header_mobile'); ?>"><i class="fas fa-phone-alt ms-2 me-2"></i><?php echo truelysell_fl_framework_getoptions('header_mobile'); ?></a>
				</div>
				<div class="col-md-6 text-md-end">
				<i class="fas fa-location-dot me-2"></i><?php echo truelysell_fl_framework_getoptions('header_address'); ?>
				</div>
			 </div>
</div>
		</div>
<header id="masthead" class="header header-two">
...
else
{
   ...
   <a href="<?php echo esc_url( home_url( '/' ) ); ?>" ><img src="<?php echo esc_url($header_logo_url); ?>">
   </a>
...
<a href="<?php echo esc_url( home_url( '/' ) ); ?>" ><img src="<?php echo esc_url($headerm_logo_url); ?>">
</a>
