<?php 
$top_header_status = truelysell_fl_framework_getoptions('enable_topheader',false); 
if(is_singular()){
	$top_header_page = get_post_meta($post->ID, 'truelysell_top_bar', TRUE);
...
if($top_header_status) : 
	$top_header_phone = truelysell_fl_framework_getoptions('top_header_phone');
	$top_header_email = truelysell_fl_framework_getoptions('top_header_email');
	$dropdown_text = truelysell_fl_framework_getoptions('top_header_dropdown');
?>
<div id="top-bar" >
	<div class="container">
		<!-- Left Side Content -->
					...
					<div class="top-bar-dropdown">
						...
						wp_nav_menu( 
							array( 
								...
								'menu_class' => 'options',
								'container' => false, 
								'fallback_cb' => 'truelysell_get_fallback_top_menu',
							) ); 
						?>
					</div>
				</li>
		...
		<div class="right-side">
			<?php 
                $headericons = get_option( 'truelysell_top_social_icons', array() );
