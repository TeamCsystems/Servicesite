 ...
 * @since 1.0.0
 */
class Widget_Truelysell_Accordion extends Widget_Base {
	...
	public function get_title() {
		return __( 'Truelysell Accordion', 'truelysell_elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_toggle',
			[
				'label' => esc_html__( 'Accordion', 'truelysell_elementor' ),
			]
		);
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__( 'Accordion Items', 'truelysell_elementor' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'tab_title' => esc_html__( 'Accordion #1', 'truelysell_elementor' ),
					...
					[
						'tab_title' => esc_html__( 'Accordion #2', 'truelysell_elementor' ),
						'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'truelysell_elementor' ),
					],
				],
				...
				?>
                              ...
                              <div class="support-card">
								<h4 class="support-title">
									<a class="collapsed" data-bs-toggle="collapse" href="#accordion_<?php echo $tab_count; ?>" aria-expanded="false"><?php $this->print_unescaped_setting( 'tab_title', 'tabs', $index ); ?></a>
								</h4>
								<div class="card-collapse collapse" id="accordion_<?php echo $tab_count; ?>">
