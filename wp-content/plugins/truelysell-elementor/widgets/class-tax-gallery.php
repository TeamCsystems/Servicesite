...
class TaxonomyGallery extends Widget_Base {
	...
	public function get_name() {
		return 'truelysell-taxonomy-gallery';
	}
	...
	public function get_title() {
		return __( 'Taxonomy Gallery', 'truelysell_elementor' );
	}
...
// 	'taxonomy' => '',
   ...
   //          'autoplayspeed'      => '3000',
		$this->add_control(
			'item_description',
			[
				'label' => __( 'Right side Content', 'truelysell_elementor' ),
				...
				'default' => __( '<h2>Find Your Ultimate <br> Local Weekend</h2>
					...
					<a href="listings-list-with-sidebar.html" class="button margin-top-25">Discover Places</a>', 'truelysell_elementor' ),
				'placeholder' => __( 'Type content description here', 'truelysell_elementor' ),
			]
		);
		$this->add_control(
			'taxonomy',
		...
		<section class="fullwidth taxonomy-gallery-container  padding-top-75 padding-bottom-70" data-background-color="#f9f9f9">
			...
			<div class="gallery-wrap">
				...
				<a href="<?php echo esc_url(get_term_link( $term )); ?>" class="item">
					<h3><?php echo $term->name; ?> <?php if($settings['show_counter'] == 'yes'): ?><span><?php $count = truelysell_get_term_post_count( $settings['taxonomy'],$term->term_id); printf( _n( '%s Listing', '%s Listings', $count, 'truelysell_elementor' ), $count ); ?></span><?php endif; ?></h3>
