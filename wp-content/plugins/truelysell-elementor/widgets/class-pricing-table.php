...
class PricingTable extends Widget_Base {
	...
	public function get_name() {
		return 'truelysell-pricingtable';
	}
	...
	public function get_title() {
		return __( 'Pricing Table', 'truelysell_elementor' );
	}
 ...
 //        "buttontext"    => 'Sign Up',
		...
		$this->add_control(
			'price',
			array(
				'label'   => __( 'Price', 'truelysell_elementor' ),
				'type'    => \Elementor\Controls_Manager::TEXT,
				'default' => __( '19.99', 'truelysell_elementor' ),
			)
		);	
		$this->add_control(
			'discounted',
			array(
				'label'   => __( 'Discount', 'truelysell_elementor' ),
				'type'    => \Elementor\Controls_Manager::TEXT,
				'default' => __( '8.99', 'truelysell_elementor' ),
			)
		);	
		$this->add_control(
			'per',
			array(
				'label'   => __( 'Per', 'truelysell_elementor' ),
				'type'    => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'month', 'truelysell_elementor' ),
			)
		);
		...
		$this->add_control(
			'buttonlink',
			[
				'label' => __( 'Buy button URL','truelysell_elementor' ),
		...
		$this->add_control(
			'buttontext',
			[
				'label' => __( 'Buy button Label','truelysell_elementor' ),
				'type'    => \Elementor\Controls_Manager::TEXT,
				'placeholder' => __( 'Buy Now', 'truelysell_elementor' ),
	...
	protected function render() {
		...
		if($settings['type'] == 'yes') { ?>
	        <div class="listing-badge">
	            <span class="featured"><?php esc_html__('Featured','truelysell_elementor') ?></span>
	        </div>
	    <?php } ?>
