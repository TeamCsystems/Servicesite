...
class Addresbox extends Widget_Base {
	...
	public function get_title() {
		return __( 'Truelysell Address Box', 'truelysell_elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'content',
			[
				'label' => __( 'Address', 'truelysell_elementor' ),
				'type' => \Elementor\Controls_Manager::WYSIWYG,
				'rows' => 5,
				'placeholder' => __( 'Enter your Address & details', 'truelysell_elementor' ),
			]
		);
		...
		$this->add_control(
			'latitude',
			array(
				'label'   => __( 'Map Marker Latitude', 'truelysell_elementor' ),
		...
		$this->add_control(
			'longitude',
			array(
				'label'   => __( 'Map Marker Longitude', 'truelysell_elementor' ),
				'type'    => Controls_Manager::TEXT,
			)
		);	
		$this->add_control(
	...
	protected function render() {
		...
		<div class="contact-map margin-bottom-55">
			...
			<div id="singleListingMap-container">
				...
				<a href="#" id="streetView"><?php echo esc_html__('Street View','truelysell_elementor') ?></a>
			</div>
