...
class WooProductsCarousel extends Widget_Base
{
	...
	{
		return 'truelysell-woocommerce-products-carousel';
	}
	...
	{
		return __('Truelysell Products Carousel', 'truelysell_elementor');
	}
	...
	protected function _register_controls()
	{
		...
		$this->add_control(
			'limit',
			[
				'label' => __('Products to display', 'truelysell_elementor'),
		...
		$this->add_control(
			'product_types',
			[
				'label' => esc_html__('Product Types', 'truelysell_elementor'),
				'placeholder' => esc_html__('Choose Products to Include', 'truelysell_elementor'),
				'type' => \Elementor\Controls_Manager::SELECT2,
				'label_block' => true,
				'multiple' => true,
				'default' => '',
		...
		$this->add_control(
			'tax-product_cat',
			[
				'label' => __('Show only from  categories', 'truelysell_elementor'),
		...
		$this->add_control(
			'exclude_posts',
			[
				'label' => __('Exclude Products', 'truelysell_elementor'),
				'type' => Controls_Manager::SELECT2,
				'label_block' => true,
				'multiple' => true,
				'default' => [],
		...
		$this->add_control(
			'include_posts',
			[
				'label' => __('Include Products', 'truelysell_elementor'),
				'type' => Controls_Manager::SELECT2,
				'label_block' => true,
				'multiple' => true,
				'default' => [],
		...
		$this->add_control(
			'fullwidth',
			[
				'label' => __('Show fullwidth slider', 'truelysell_elementor'),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => __('Show', 'your-plugin'),
				'label_off' => __('Hide', 'your-plugin'),
				'return_value' => 'yes',
	...
	protected function render()
	{
		...
		if ($settings['fullwidth']) { ?>
			<!-- Carousel / Start -->
			<div data-slides="6" class="simple-fw-slick-carousel truelysell-products-slider  dots-nav" <?php if ($settings['autoplay'] == 'yes') { ?> data-slick='{"autoplay": true, "autoplaySpeed": <?php echo $settings['autoplayspeed']; ?>}' <?php } ?>>
			<?php } else { ?>
				<!-- Carousel / Start -->
				<div data-slides="4" class="simple-slick-carousel  truelysell-products-slider dots-nav" <?php if ($settings['autoplay'] == 'yes') { ?> data-slick='{"autoplay": true, "autoplaySpeed": <?php echo $settings['autoplayspeed']; ?>}' <?php } ?>>
					<?php }
				if ($products) {
					$count = 0;
