...
class HomeBanner extends Widget_Base {
	...
	public function get_title() {
		return __( 'Home Banner', 'truelysell_elementor' );
	}
 ...
 // 'title' 		=> 'Service Title',
	...
	// 	    'with_line' 	=> 'yes',
		...
		$this->add_control(
			...
			array(
				...
				'default' => __( 'Find Nearby Attractions', 'truelysell_elementor' ),
			)
		);	
		$this->add_control(
			'subtitle',
			array(
				...
				'type'    => Controls_Manager::TEXT,
				'default' => __( 'Explore top-rated attractions, activities and more!', 'truelysell_elementor' ),
			)
		);	
		$this->add_control(
			'search_form_style',
			[
				'label' => __( 'Search form style ', 'truelysell_elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'wide',
				'options' => [
					'wide' => __( 'Wide', 'truelysell_elementor' ),
					'boxed' => __( 'Boxed', 'truelysell_elementor' ),
		...
		$this->add_control(
			'header_style',
			[
				'label' => __( 'Header style ', 'truelysell_elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'transparent-header',
				'options' => [
					'transparent-header' => __( 'Transparent', 'truelysell_elementor' ),
					'solid-header' => __( 'Solid', 'truelysell_elementor' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Text alignment ', 'truelysell_elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'left',
				'options' => [
					'center' => __( 'Center', 'truelysell_elementor' ),
					'left' 	 => __( 'Left', 'truelysell_elementor' ),
		...
		$this->add_control(
			'video',
			[
				'label' => __( 'Choose Video', 'truelysell_elementor' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
		...
		$this->add_control(
			'video_poster',
			[
				'label' => __( 'Choose Video Poster Image', 'truelysell_elementor' ),
				'type' => \Elementor\Controls_Manager::MEDIA,
				'default' => [
		...
		$this->add_control(
			'solid_background',
			[
				'label' => __( 'Solid Background Color', 'truelysell_elementor' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'left',
				'options' => [
					'solid' => __( 'Solid color', 'truelysell_elementor' ),
					'gradient' 	 => __( 'Gradient', 'truelysell_elementor' ),
		...
		// 	'home_full_screen',
		// 	[
		// 		'label' => __( 'Full screen banner', 'truelysell_elementor'  ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Show Featured Categories', 'truelysell_elementor'  ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'truelysell_elementor' ),
				'label_off' => __( 'Hide', 'truelysell_elementor' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Show in Featured Categories this terms', 'truelysell_elementor' ),
	...
	protected function render() {
		...
		if(!empty($settings['background']['url'])){
			...
			$background_image = get_option( 'truelysell_search_bg'); 
		}
			...
			<div class="container">
				...
				if($settings['featured_categories_status']=='yes') :
					...
					if(isset($settings['tax-listing_category'])) :
							...
							<div class="row">
								<div class="col-md-12">
									<h5 class="highlighted-categories-headline"><?php esc_html_e('Or browse featured categories:','truelysell') ?></h5>
										...
										foreach ($category as $value) {
											...
											if( $term && ! is_wp_error( $term ) ) {
												...
												<a href="<?php echo get_term_link($term->slug, 'listing_category'); ?>" class="highlighted-category">
													...
													<i>
														<?php echo truelysell_render_svg_icon($_icon_svg); ?>
													</i>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="main-search-input">
						...
						<?php echo do_shortcode('[truelysell_search_form action='.get_post_type_archive_link( 'listing' ).' source="homebox" custom_class="main-search-form"]') ?>
