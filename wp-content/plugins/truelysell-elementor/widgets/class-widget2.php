 ...
 * @since 1.0.0
 */
class Truelysell2 extends Widget_Base {
	...
	public function get_title() {
		return __( 'Truelysell2', 'truelysell_elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'description',
			array(
				'label'   => __( 'Description', 'truelysell_elementor' ),
				'type'    => Controls_Manager::TEXTAREA,
				'default' => __( 'Description', 'truelysell_elementor' ),
			)
		);
