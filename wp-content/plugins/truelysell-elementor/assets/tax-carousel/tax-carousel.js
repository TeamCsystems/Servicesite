class TruelysellTaxonomyCarousel extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
...
jQuery( window ).on( 'elementor/frontend/init', () => {
   const addHandler = ( $element ) => {
       elementorFrontend.elementsHandler.addHandler( TruelysellTaxonomyCarousel, {
           $element,
       } );
   };

   elementorFrontend.hooks.addAction( 'frontend/element_ready/truelysell-taxonomy-carousel.default', addHandler );
} );
