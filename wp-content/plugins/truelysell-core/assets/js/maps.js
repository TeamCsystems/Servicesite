  ...
  $(function () {
    ...
    var geooptions = {};  
     if(truelysell_core.country){
      geooptions = {componentRestrictions:{country:truelysell_core.country}}; 
    } 
    ...
    if(truelysell_core.centerPoint) {
    ...
    function locationData(locationURL,locationImg,locationTitle, locationAddress, locationRating, locationRatingCounter) {
      ...
      output_top= ''+
        ...
        if(locationRating>0){
            output_bottom = '<div class="'+infoBox_ratingType+'" data-rating="'+locationRating+'"><div class="rating-counter">('+locationRatingCounter+' '+truelysell_core.maps_reviews_text+')</div></div>'+
               '</div>'+
            '</div>';
        } else {
...
if(truelysell_core.maps_autolocate){
  $(".geoLocation,.location:not(.add-listing-section) a,form-field-_address-container a").trigger('click')
    ...
    function singleListingMap() {
      ...
      var single_zoom = parseInt(truelysell_core.maps_single_zoom);
