...
<div class="listing-links-container">
	<?php 
	$visibility_setting = truelysell_fl_framework_getoptions('user_contact_details_visibility'); // hide_all, show_all, show_logged, show_booked,  
	...
	if($contacts) : 
		...
		if($show_details){ ?>
			...
			<ul class="listing-links contact-links">
				...
				<li><a href="mailto:<?php echo esc_attr($mail); ?>" class="listing-links"><i class="fa fa-envelope"></i> <?php echo esc_html($mail); ?></a>
				</li>
				<?php endif; ?>
				...
				if(isset($url['host'])) { echo esc_html($url['host']); } else { esc_html_e('Visit website', 'truelysell_core'); } ?></a></li>
				<?php endif; ?>
			</ul>
		...
		if($visibility_setting != 'hide_all') {?>
			<p><?php printf( esc_html__( 'Please %s sign %s in to see contact details.', 'truelysell_core' ), '<a href="#sign-in-dialog" class="sign-in popup-with-zoom-anim">', '</a>' ) ?></p>
		<?php } ?>
		<?php }
	endif; ?>
