...
if(!empty($place_id)){
	$place_data = truelysell_get_google_reviews($post);
...
<div id="listing-google-reviews" class="listing-section">
	<h3 class="listing-desc-headline margin-top-75 margin-bottom-20"><?php esc_html_e('Google Reviews','truelysell_core'); ?></h3>
...
<?php
		...
		printf( // WPCS: XSS OK.
			esc_html( _nx(  'Review %1$s','%1$s reviews', $google_reviews_count, 'comments title', 'truelysell_core' ) ),
	...
	?>
	    ...
	    <div class="google-reviews-read-more">
	        <a href="https://search.google.com/local/writereview?placeid=<?php echo $place_id; ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/google-reviews-button-icon.svg" alt="<?php esc_attr('Reviewimg', 'truelysell');><?php esc_html_e('Add Review','truelysell_core'); ?></a>
	    </div>
	    
	</div>
	
    <section class="comments listing-reviews 3">
    ...
    <?php }
      ?>
	    ...
	    <div class="google-reviews-read-more bottom">
	        <a href="https://search.google.com/local/reviews?placeid=<?php echo $place_id ?>" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/google-reviews-logo.svg"><?php esc_html_e('Read More Reviews','truelysell_core'); ?></a>
	    </div>
	  </div>
<?php } ?>
