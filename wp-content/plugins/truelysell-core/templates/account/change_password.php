...
<div class="col-md-8">
	<div class="row">
		<div class="col-md-6  my-profile">
			...
			<h4 class="margin-top-0 margin-bottom-30"><?php esc_html_e('Change Password','truelysell_core'); ?></h4>
			...
			<form name="resetpasswordform" action="" method="post">
				<label><?php esc_html_e('Current Password','truelysell_core'); ?></label>
				<input type="password" name="current_pass">

				<label for="pass1"><?php esc_html_e('New Password','truelysell_core'); ?></label>
				<input name="pass1" type="password">

				<label for="pass2"><?php esc_html_e('Confirm New Password','truelysell_core'); ?></label>
				<input name="pass2" type="password">

				<input type="submit" name="wp-submit" id="wp-submit" class="margin-top-20 button" value="<?php esc_html_e('Save Changes','truelysell_core'); ?>" />
