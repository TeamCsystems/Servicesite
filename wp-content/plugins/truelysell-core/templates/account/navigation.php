	...
	<div class="sidebar left">
		...
		<div class="my-account-nav-container">
			...
			<ul class="my-account-nav">
				<li class="sub-nav-title"><?php esc_html_e('Manage Account','truelysell_core');?></li>
				<li>
					<a href="<?php echo get_permalink(get_option( 'my_account_page' )); ?>" 
					<?php if( $current == 'profile' ) { echo 'class="current"'; }?>>
					<i class="sl sl-icon-user"></i> <?php esc_html_e('My Profile','truelysell_core');?>
					</a>
				</li>
				<li>
					<a href="<?php echo get_permalink(get_option( 'bookmarks_page' ))?>" 
					<?php if( $current == 'bookmarks' ) { echo 'class="current"'; }?>>
						<i class="sl sl-icon-star"></i> <?php esc_html_e('Bookmarked Listings','truelysell_core');?>
					</a>
				</li>
			</ul>
			
			<ul class="my-account-nav">
				<li class="sub-nav-title"><?php esc_html_e('Manage Listings','truelysell_core');?></li>
				...
				<li>
					...
					<?php if( $current == 'my_listings' ) { echo 'class="current"'; }?> >
						...
						<?php esc_html_e('My Properties','truelysell_core');?>
					</a>
				</li>
				<?php } ?>
				...
				<li>
					...
					<?php if( $current == 'submit' ) { echo 'class="current"'; }?> >
						...
						<?php esc_html_e('Submit New Listing','truelysell_core');?>
					</a>
				</li>
				<?php } ?>	
				...
				<li>
					...
					<?php if( $current == 'my_packages' ) { echo 'class="current"'; }?> >
						...
						<?php esc_html_e('My Packages','truelysell_core');?>
					</a>
				</li>
				<?php } ?>	
			</ul>
			...
			<ul class="my-account-nav">
				...
				<li>
					...
					<i class="sl sl-icon-lock"></i> <?php esc_html_e('Change Password','truelysell_core');?>
					</a>
				</li>
				<?php } ?>
				<li><a href="<?php echo wp_logout_url(get_permalink(get_option( 'my_account_page' ))); ?>"><i class="sl sl-icon-power"></i> <?php esc_html_e('Log Out','truelysell_core');?></a></li>
			</ul>
