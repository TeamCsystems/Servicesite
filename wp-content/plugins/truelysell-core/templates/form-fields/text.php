...
<?php } ?>
<input type="text" 
	class="input-text <?php echo esc_attr( isset( $field['class'] ) ? $field['class'] : $key ); ?> form-control" 
...
<?php if( $field['name']=='_address') { ?>
		<a href="#"><i title="<?php esc_html_e('Find My Location','truelysell_core') ?>" class="tooltip left fa fa-map-marker"></i></a>
	<span class="type-and-click-btn"><?php esc_html_e('type and click here','truelysell_core') ?></span>
	<span class="type-and-hit-enter"><?php esc_html_e('type and hit enter','truelysell_core') ?></span>
</div>
<?php } ?>