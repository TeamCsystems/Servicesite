...
<div class="truelysell-uploaded-file">
		...
		if ( 'image' === wp_ext2type( $extension ) ) : ?>
			<span class="truelysell-uploaded-file-preview"><img src="<?php echo esc_url( $image_src ); ?>" /> 
			<a class="remove-uploaded-file" href="#"><?php _e( 'Remove file', 'truelysell_core' ); ?></a></span>
		<?php else : ?>
			<span class="truelysell-uploaded-file-name"><?php echo esc_html( basename( $image_src ) ); ?> 
			<a class="remove-uploaded-file" href="#"><?php _e( 'Remove file', 'truelysell_core' ); ?></a></span>
		<?php endif; ?>
