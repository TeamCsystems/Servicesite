...
if(isset($field['description'])){
	echo '<div class="notification closeable notice"><p class="description alert alert-info" id="'.$key.'-description">'.$field['description'].'</p></div>';
}
...
<div id="media-uploader" <?php if(isset($field['max_files']) && $field['max_files']>0) { ?> data-maxfiles="<?php echo $field['max_files']; ?>" <?php } ?> class="dropzone <?php echo esc_attr($data->key); ?>">
	<div class="dz-default dz-message"><span><i class="fa fa-plus"></i> <?php esc_html_e('Click here or drop files to upload','truelysell_core') ?></span></div>
</div>
