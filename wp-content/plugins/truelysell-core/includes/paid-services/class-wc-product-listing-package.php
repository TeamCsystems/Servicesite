...
// add a product type
add_filter( 'product_type_selector', 'truelysell_core_add_listing_product_type' );
function truelysell_core_add_listing_product_type( $types ){
    $types[ 'listing_package' ] = __( 'Listing Package' );
     if ( class_exists( 'WC_Subscriptions' ) ) {
			$types['listing_package_subscription'] = __( 'Listing Package Subscription', 'truelysell_core' );
			
	}
    return $types;
}

function truelysell_core_create_listing_product_type() {
	...
	class WC_Product_Listing_Package extends WC_Product {
		...
		public function get_duration() {
			...
			if ( $listing_duration ) {
				...
				return get_option( 'truelysell_core_submission_duration' );
			}
		}
...
add_action( 'plugins_loaded', 'truelysell_core_create_listing_product_type' );
