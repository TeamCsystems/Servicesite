 ...
 */
class WC_Product_Listing_Package_Subscription extends Truelysell_Core_Paid_Listings_Subscription_Product {
	...
	public function get_duration() {
		...
		if ( 'listing' === $this->get_package_subscription_type() ) {
			...
			return truelysell_fl_framework_getoptions('default_duration' );
		}
	}
