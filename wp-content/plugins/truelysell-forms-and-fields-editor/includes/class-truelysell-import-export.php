...
class Truelysell_Forms_Import_Export {
	/**
    ...
    public function add_options_page() {        
         add_submenu_page( 'truelysell-fields-and-form', 'Import/Export', 'Import/Export', 'manage_options', 'truelysell-import-export', array( $this, 'output' )); 
    ...
    function truelysell_process_settings_import() {
        ...
        wp_safe_redirect( admin_url( 'admin.php?page=truelysell-import-export&import=success' ) ); exit;
